...
namespace FileSystem.models
{
    public class FileSystem
    {
        ...
        {
            LogAction("InitFromFile", "info", $"Run");
        ...
        public void CheckSecretCode(bool isActive)
        {
            ...
            {
                LogAction("CheckSecretCode", "info", $"Stop CheckSecretCode");
            }
        }
        ...
        {
            LogAction("UserAdd", "info", $"Run with params: {name}, {rights}");
        ...
        public void LogAction(string actionName, string actionStatus, string result)
        {
